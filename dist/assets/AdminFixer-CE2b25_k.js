import{j as a,d as i}from"./index-DaEBHKGl.js";import{r as u}from"./router-Z28cWG60.js";import"./react-Bq7xPAhO.js";import"./ui-BpKHBLDN.js";function R(){const[d,r]=u.useState(""),[c,t]=u.useState(!1),p=async()=>{t(!0),r("Detecting your email...");try{const{data:{user:e},error:o}=await i.auth.getUser();if(o||!e){r(`
❌ NOT LOGGED IN
