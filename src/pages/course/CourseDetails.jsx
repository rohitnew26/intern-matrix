...
const CourseDetails = () => {
  ...
  flex flex-col md:flex-row gap-6 md:gap-8 items-center md:items-start"
    ...
    "
        ...
        {( course?.overview || course?.description || course?.meta_description||  (course?.detailed_description && Array.isArray(course.detailed_description.sections) && course.detailed_description.sections.length > 0)) && (
          <>
