...
const NavBar = () => {
  ...
  // Prevent rapid repeated navigations (e.g., accidental double clicks)
    ...
    <nav className="sticky top-0 w-full z-50 bg-black/90 backdrop-blur-md shadow-lg">
      <div className="max-w-7xl mx-auto px-5 py-4 flex justify-between items-center">
        ...
        <Link
          ...
          onClick={(e) => {
            // guard against propagation and very fast repeated navigations
            e.preventDefault();
            e.stopPropagation();
            if (navLocked) return;
            setNavLocked(true);
            ...
            setTimeout(() => setNavLocked(false), 500);
          }}
        >
